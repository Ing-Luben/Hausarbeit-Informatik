...
# Frage Chat GPT, nachdem du ihm die aktuellste Version geschickt hast, wie ich dafür sorge, 
# dass diese Funktion die hier vor der dem Menu funktioniert hat, jetzt auch in der Funktion nach dem Befehl funktioniert!!
# vorher funktionierender Code habe ich unten dran gehangen, hinter Menu()
...
if __name__ == "__main__":
    ...
    print("Anzahl Einträge:", len(daten))
    print(daten[0])
